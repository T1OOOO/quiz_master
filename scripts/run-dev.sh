...
AUTH_DB_DRIVER="$AUTH_DB_DRIVER" AUTH_DB_DSN="$AUTH_DB_DSN" AUTH_DB_PATH="$AUTH_DB_PATH" STORAGE_DB_DRIVER="$STORAGE_DB_DRIVER" STORAGE_DB_DSN="$STORAGE_DB_DSN" STORAGE_DB_PATH="$STORAGE_DB_PATH" AUTH_API_TOKEN="$AUTH_API_TOKEN" STORAGE_API_TOKEN="$STORAGE_API_TOKEN" "$ROOT_DIR/scripts/run-servers.sh"
sleep 3
